...
public class Global {
	...
	public static java.math.BigDecimal DecTime4=new BigDecimal("10000");
	...
	public static java.math.BigDecimal Dec4=new BigDecimal("0.0001");		//精确到0.01分
	
	public static String serialSecFormat ="yyMMddHHmmss";
}
