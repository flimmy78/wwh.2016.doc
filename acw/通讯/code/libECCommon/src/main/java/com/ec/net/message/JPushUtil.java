...
public class JPushUtil
{
     ...
     *           设备类型  1 安卓 2 ios  
     * @param type
     *           消息类型  1 充电结束推送    2 余额不足推送     3充电开始推送    4消费记录    5预约完成  6取消预约    7后台全推  8不同设备登陆      9系统通知
     * @return 
     */
    public static DataModel point2point( String alert, String msg, Map<String, String> extras,String registrationID, String deviceType)
    {
