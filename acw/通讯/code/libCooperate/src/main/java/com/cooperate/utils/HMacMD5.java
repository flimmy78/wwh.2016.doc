...
//		String sigStr = "{\"OperatorID:\"425010765\",\"&OperatorSecret:\"1234567890abcdef\"}";
		String org = "425010765";
		String data = "3cYGcsYXezutkwUCXxOgo6WLQ/ZC0pcvmMFoyER4CQeUH26OynCo/m4XzwUfcKYaHIEuo0Rgq6y+XqPOMjZ6hjX+h40WnImljAbLomyM4P0=";
		String timeStamp = "20170420145007";
		String seq = "0001";
		String sigStr = org + data +  timeStamp  + seq;
//		String sigStr = "3cYGcsYXezutkwUCXxOgo6WLQ/ZC0pcvmMFoyER4CQeDfOZjgrOKBhdS7itkQG1ZuBzI2aOKMLVhCyUREqe+9w==";
		System.out.println(sigStr);
	System.out.println(getHmacMd5Str("1234567890abcdef", sigStr));
//		System.out.println(getHmacMd5Str("1234567890abcdef", "OperatorID=425010765&Data="LastQueryTime":1,"PageNo":1,"PageSize":10&TimeStamp=20170420145007&Seq=0001));
	}
}
