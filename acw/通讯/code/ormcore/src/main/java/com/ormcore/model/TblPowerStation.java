...
public class TblPowerStation {
	private java.lang.Integer pkPowerstation; // 主键
	private java.lang.String postName; // 电站名称
	private java.lang.String postPic; // 电站图片
	private java.lang.String postDetailpic; // 电站详情图片
	...
	private java.lang.String postEleids; // 电站绑定相关电桩，电桩id用逗号隔开
	private java.lang.Integer postStatus; // 电站状态（0草稿，5提交审核，3已驳回，10离线，15上线）
	private java.lang.Integer postAreacode; // 电站所属区域代码，根据省、市、区代码表关联
	...
	private Integer chargingMode; //电站的电桩充电模式
	...
	private String powerState;// 电站状态
	private String powerStationSum;// 电站电桩数量
	...
	/**
	 * 获取电站状态（0草稿，5提交审核，3已驳回，10离线，15上线）属性
	 * 
	 * @return postStatus
	 */
	...
	/**
	 * 设置电站状态（0草稿，5提交审核，3已驳回，10离线，15上线）属性
	 * 
	 * @param postStatus
	 */
	...
	public String toString() {
		...
		sb.append(", postEleids=").append(postEleids);
		...
		sb.append(", postIsappoint=").append(postIsappoint);
		sb.append('}');
		return sb.toString();
	}
}
